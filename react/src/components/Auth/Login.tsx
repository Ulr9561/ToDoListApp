...
import axiosClient, { axiosCl } from "../../axios";
...
const Login: React.FC = () => {
	...
	return (
		<div className="login-container">
			<div className="container active fixed mt-[-1.3%]">
				<p
					ref={errRef}
				...
				<form action="" onSubmit={handleSubmit}>
					...
					<div className="input-box username">
						...
						<p
							id="uidnote"
							className={
								userFocus && username.trim() !== "" && !validName
									? "instructions"
									: "offscreen"
							}
						>
					...
					<div className="input-box password">
						...
						>
							<FaInfoCircle />
							Must be 8-24 characters long. Must include uppercase and
