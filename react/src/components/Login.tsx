...
const Login: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        await csrfToken();
        try {
            const response = await axiosClient.post('/login', JSON.stringify({ username, password }));
                ...
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className="input-box username">
                        ...
                        <p
                            id="uidnote"
                            className={
                                userFocus && username.trim() !== '' && !validName ? 'instructions' : 'offscreen'
                            }
                        >
                            <FaInfoCircle />
                    ...
                    <div className="input-box password">
                        ...
                        >
                            <FaInfoCircle />
                            Must be 8-24 characters long. Must include uppercase and lowercase letters, a number
